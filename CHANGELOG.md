...
### Added
- Image set creation and file picker for images
- Double click action to replace the image

### Changed
- Improved image deletion and updating
...
### Fixed
- Xcode-compatible JSON formatting for Contents.json

## [0.11.3] - 2026-01-27

### Fixed
- Extension validaiton
