...
[![VS Marketplace](https://img.shields.io/open-vsx/v/artemnovichkov/asset-catalog-viewer?style=for-the-badge&logo=visual-studio-code&label=VS%20Code)](https://marketplace.visualstudio.com/items?itemName=artemnovichkov.asset-catalog-viewer)
